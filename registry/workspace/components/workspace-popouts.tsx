...
import { createId } from "@/registry/workspace/lib/ids";
import {
  DEFAULT_POPOUT_HEIGHT,
  DEFAULT_POPOUT_WIDTH,
} from "@/registry/workspace/lib/model/surface";
import type { WorkspaceStore } from "@/registry/workspace/lib/store";
import {
  WorkspaceProvider,
  useWorkspaceContext,
...
import { WorkspaceStack } from "@/registry/workspace/ui/workspace-stack";
