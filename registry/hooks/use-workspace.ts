...
import { createWorkspaceStore } from "@/registry/lib/workspace/store";
import type { WorkspaceAction } from "@/registry/lib/workspace/actions";
import { resolveConfig } from "@/registry/lib/workspace/config";
import type {
  WorkspaceConfig,
  WorkspaceConfigInput,
} from "@/registry/lib/workspace/config";
import { WorkspaceDragProvider } from "@/registry/hooks/use-workspace-drag";
